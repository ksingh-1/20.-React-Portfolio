      ...
      <div className="aboutM"> 
        ...
        <p id="itemsAM">Here's Some Things About Me:</p>
          <ul>
            ...
            <li>
              I've Graduated from Southern Methodist Univeristy's Full Stack Web Development Coding Bootcamp and I have my Bachelor's Degree In Psychology from The University of Oklahoma!
            </li>
            <li>
              My fondest memories in life have been about cars and creating something that is unique and special. I see working with technology and software very similar to working on cars as you can create something from scratch or work with a team to improve existing features.
            </li>
            <li>
